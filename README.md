...
| <img src="https://github.com/nazmulidris/developerlife.com/blob/main/assets/nazmul.png?raw=true"/> | Hi, I'm <a href="https://nazmulidris.com"> Nazmul</a> 😃. I am a **Rustacean Systems Engineering Leader & Founder** building next-generation terminal platforms and developer tooling for the AI & cloud era. Also an ex-Googler (Android Studio), <a href="https://github.com/r3bl-org/r3bl-open-core/" target="_blank">founder, engineer, maintainer</a>, designer, leader, HsingI-er, racer, storyteller. I 💓 leadership, authenticity, play and hope. |
| -------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
### Building Terminal Platforms & Developer Tools for the AI & Cloud Era ([ROC](https://github.com/r3bl-org/r3bl-open-core))
...
- **AI & MCP Servers:** High-performance Model Context Protocol (MCP) integrations (such as `rust-analyzer-mcp-server`) bridging autonomous AI agents directly with local toolchains.
